...
**
**
** DOSYA ACIKLAMSI........: Her bir elemanında integer veriye sahip kuyruk tutan kuyruk sinifinin dugum sinifi
****************************************************************************************************/
#include "intKuyrukYildizDugum.hpp"

intKuyrukYildizDugum::intKuyrukYildizDugum(intKuyruk* veri)
{
	this->veri = veri;
	sonraki = NULL;
