...
**
**
** DOSYA ACIKLAMSI........: Her bir elemanında intYildizKuyruk sinifindan eleman tutan kuyruk sinifinin dugum sinifi
****************************************************************************************************/
#include "kuyrukYildizDugum.hpp"


kuyrukYildizDugum::kuyrukYildizDugum(intYildizKuyruk* veri)
{
	this->veri = veri;
	sonraki = NULL;
